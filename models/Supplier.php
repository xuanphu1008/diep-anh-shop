...
class Supplier {
    ...
    // Methods for admin panel with filters
    public function getAdminSuppliers($filters, $perPage, $offset) {
    ...
    public function countAdminSuppliers($filters) {
        $sql = "SELECT COUNT(*) as total FROM suppliers WHERE deleted_at IS NULL";
        $params = [];
